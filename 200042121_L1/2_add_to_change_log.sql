...
call add_to_change_log("Mirza Mohammad Azwad","1_create_changelog.sql","CREATE CHANGE LOG");
call add_to_change_log("Mirza Mohammad Azwad","2_add_to_change_log.sql","CREATE PROCEDURE FOR ADD TO CHANGE LOG");